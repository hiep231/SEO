...
async function seed() {
	try {
		...
		const catMap = {
			...
			"op-lung-kinh": insertedCategories.find((c) => c.slug === "op-lung-kinh")
				?._id,
			"ban-phim-chuot": insertedCategories.find(
				(c) => c.slug === "ban-phim-chuot",
			)?._id,
		};
		...
		const productsData = [
			// Tai Nghe
			{
				...
				imgUrls: [
					"https://images.unsplash.com/photo-1600294037681-c80b4cb5b434?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Tai nghe AirPods Pro 2 chống ồn chủ động xuất sắc, âm thanh chuẩn H2 chip, thời lượng pin 30h. Lựa chọn tuyệt vời cho người dùng hệ sinh thái Apple.",
				),
			...
			},
			{
				...
				description: t(
					"Tai nghe Sony WH-1000XM5 với khả năng chống ồn hàng đầu, âm thanh Hi-Res, thiết kế siêu nhẹ, pin 30h. Phù hợp cho công việc và giải trí.",
				),
			...
			},
			{
				...
				description: t(
					"Tai nghe Marshall Major IV thiết kế cổ điển, thời lượng pin ấn tượng lên tới 80 giờ, âm bass mạnh mẽ, hỗ trợ sạc không dây.",
				),
			...
			},
			{
				...
				imgUrls: [
					"https://images.unsplash.com/photo-1572569438065-2449cb8a501f?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Galaxy Buds 2 Pro mang đến trải nghiệm âm thanh 24-bit Hi-Fi ấn tượng, thiết kế nhỏ gọn, chống ồn chủ động thông minh.",
				),
			...
			},
			{
				...
				description: t(
					"Tai nghe chụp tai JBL Tune 510BT với công nghệ JBL Pure Bass Sound, pin 40h, sạc nhanh 5 phút dùng 2 giờ.",
				),
			...
			// Sạc & Pin
			{
				...
				description: t(
					"Sạc nhanh Anker Nano Pro 20W kích thước siêu nhỏ gọn, hỗ trợ sạc nhanh cho iPhone 15/14 series an toàn và ổn định.",
				),
			...
			},
			{
				...
				description: t(
					"Pin dự phòng Baseus dung lượng 20000mAh, hỗ trợ sạc nhanh 20W, tích hợp màn hình LED hiển thị % pin. Sạc được 3 thiết bị cùng lúc.",
				),
			...
			},
			{
				...
				description: t(
					"Sạc Ugreen Nexode 65W sử dụng công nghệ GaN, 3 cổng sạc (2 Type-C, 1 USB-A) sạc nhanh được cho cả MacBook và điện thoại.",
				),
			...
			},
			{
				...
				priceCompare: 790000,
				imgUrls: [
					"https://images.unsplash.com/photo-1622445272461-c6580cab6efa?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Pin sạc dự phòng chính hãng Samsung dung lượng 10000mAh, vỏ kim loại sang trọng, hỗ trợ sạc nhanh chuẩn PD và SFC.",
				),
			...
			},
			{
				...
				imgUrls: [
					"https://images.unsplash.com/photo-1611078734062-8e80d4407ab4?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Sạc không dây MagSafe chính hãng Apple, công suất 15W, hít nam châm chắc chắn cho dòng iPhone 12 trở lên.",
				),
			...
			// Ốp lưng & Kính
			{
				...
				priceCompare: 550000,
				imgUrls: [
					"https://images.unsplash.com/photo-1541877888863-71f016dbbf8b?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Ốp lưng Spigen Liquid Air thiết kế hoạ tiết tam giác chống bám vân tay, công nghệ Air Cushion bảo vệ 4 góc cực tốt.",
				),
			...
			},
			{
				...
				priceCompare: 350000,
				imgUrls: [
					"https://plus.unsplash.com/premium_photo-1681313824743-15bc9e29a999?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Kính cường lực Nillkin tràn viền 3D, độ cứng 9H, chống trầy xước và va đập hiệu quả, phủ nano chống vân tay trơn láng.",
				),
			...
			},
			{
				...
				imgUrls: [
					"https://images.unsplash.com/photo-1601593346740-925612772716?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Ốp lưng UAG Pathfinder Series với cấu trúc tổ ong siêu bền, đạt chuẩn rơi thả của quân đội Mỹ, thiết kế hầm hố nam tính.",
				),
			...
			},
			{
				...
				priceCompare: 200000,
				imgUrls: [
					"https://images.unsplash.com/photo-1523206489230-c012c64b2b48?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Kính cường lực Kingkong chống nhìn trộm 30 độ, bảo vệ quyền riêng tư nơi công cộng, vuốt chạm mượt mà.",
				),
			...
			},
			{
				...
				description: t(
					"Ốp lưng trong suốt (Clear Case) chính hãng Apple, hỗ trợ Magsafe lực hút mạnh, phủ lớp chống ố vàng cao cấp.",
				),
			...
			// Bàn phím & Chuột
			{
				...
				imgUrls: [
					"https://images.unsplash.com/photo-1615663245857-ac1eeb5304af?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Chuột Logitech MX Master 3S với cảm biến 8000 DPI, nút click tĩnh âm siêu êm, cuộn từ tính MagSpeed siêu nhanh. Chuột công thái học tốt nhất cho lập trình và thiết kế.",
				),
			...
			},
			{
				...
				description: t(
					"Bàn phím cơ Keychron K8 Pro hỗ trợ QMK/VIA, lót foam tiêu âm, keycap PBT double-shot, switch Gateron Pro gõ êm mượt.",
				),
			...
			},
			{
				...
				imgUrls: [
					"https://images.unsplash.com/photo-1586816879360-004f5b0c51e3?w=800&auto=format&fit=crop&q=60",
				],
				description: t(
					"Razer DeathAdder V2 X với công nghệ không dây HyperSpeed siêu tốc, cảm biến 14K DPI, hỗ trợ dùng cả pin AA lẫn AAA cực kì tiện dụng.",
				),
			...
			},
			{
				...
				description: t(
					"Bàn phím Logitech MX Keys với thiết kế mỏng sang trọng, phím gõ êm ái với rãnh tròn, cảm biến đèn nền thông minh tự sáng khi chạm tay.",
				),
			...
			},
			{
				...
				description: t(
					"Bàn phím Akko 3098B với thiết kế màu sắc trẻ trung bắt mắt, kết nối 3 chế độ (Type-C, 2.4Ghz, Bluetooth), switch Akko CS bấm nảy nhẹ.",
				),
		...
		console.log(
			`✅ Successfully seeded 4 categories and ${insertedProducts.length} products!`,
		);
		process.exit(0);
	} catch (error) {

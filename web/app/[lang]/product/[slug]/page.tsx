...
export default async function Page({ params }: Props) {
	...
	if (slug !== canonicalSlug) {
		permanentRedirect(localizePath(`/product/${canonicalSlug}`, lang));
	}
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
	...
	const path = `/product/${createProductSlug(product.name.en, product._id)}`;

	return {
		title: `${product.name.en} Chính Hãng | Phụ Kiện Công Nghệ`,
